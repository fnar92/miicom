		...
		<div class="content-top">
			...
			<div class="col-md-8 content-top-2">
				...
				<!--graph-->
		<link rel="stylesheet" href="<?=base_url();?>assets/miicom/css/graph.css">
		<!--//graph-->
							<script src="<?=base_url();?>assets/miicom/js/jquery.flot.js"></script>
									<script>
		...
		<link href="<?=base_url();?>assets/miicom/css/owl.carousel.css" rel="stylesheet">
		<script src="<?=base_url();?>assets/miicom/js/owl.carousel.js"></script>
			<script>
				$(document).ready(function() {
